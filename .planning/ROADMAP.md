...
|-------|-----------|----------------|--------|-----------|
| 1     | v0.3      | 7/7 | Complete   | 2026-04-08 |
...
- [x] 01-06-PLAN.md — Platform drivers group 2: gemini, grok, perplexity, chatgpt_extractor
- [x] 01-07-PLAN.md — Orchestrator async tests, config/collate gaps, CI --cov-fail-under=100 gate
